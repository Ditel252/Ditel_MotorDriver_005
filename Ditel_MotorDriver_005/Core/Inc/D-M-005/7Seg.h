...
#define __7SEG_MOTOR_POWER_NORMAL_MODE_RATIO 235
#define __7SEG_MOTOR_MODE_NEUTRAL 0xB0
#define __7SEG_MOTOR_MODE_BREAK 0xB1

typedef enum{
	_SETUP_STEP_START_PROGRAM = 1,
	_SETUP_STEP_SETUP_MOTOR = 2,
	_SETUP_STEP_SETUP_AND_READ_SWICH = 3,
	_SETUP_STEP_SETUP_CONSOLE = 4,
	_SETUP_STEP_SETUP_ROTARY_ENCODER = 5,
	_SETUP_STEP_SETUP_PID = 6,
	_SETUP_STEP_SETUO_CAN = 7,
	_SETUP_STEP_NULL6 = 8,
